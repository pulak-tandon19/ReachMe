...
urlpatterns = [
    ...
    path('post/<int:post_pk>/comment/<int:pk>/<int:comment_level>/reply', CommentReplyView.as_view(), name='comment-reply'),
    ...
    path('notification/delete/', ClearNotifications.as_view(), name='clear-notifications'),
