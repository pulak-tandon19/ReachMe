...
class Comment(models.Model):
    ...
    replies= models.ManyToManyField('self', blank='True', null='True', related_name='+')
    tags= models.ManyToManyField('Tag', blank=True)
...
class UserProfile(models.Model):
    ...
    picture=models.ImageField(upload_to='uploads/profile_pictures', default='uploads/profile_pictures/default_weuid3.png', blank=True)
